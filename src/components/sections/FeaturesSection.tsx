...
const features = [
  {
    ...
    description:
      "Your AI content manager doesn\u2019t copy-paste. Your LinkedIn post sounds professional, your tweet is punchy, your Threads post is conversational \u2014 all from a single message.",
  },
  {
    icon: Shield,
...
const comparisons = [
  ...
  },
  {
    ...
    with: "From $17/mo \u2014 everything included",
  },
];
