      ...
      <div className="mx-auto max-w-[1100px]">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-5 max-w-[560px] text-base leading-[1.55] text-[#b9bdd6] md:text-[17px]">
            ...
            API. Proven infrastructure for reliable publishing to Instagram.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-[520px]">
          ...
          >
            ...
            <div className="mb-4 flex items-center gap-3">
              ...
              <span className="text-xs text-[#7a7fa0]">Instagram</span>
            </div>
            ...
            <p className="text-[15px] leading-[1.6] text-[#b9bdd6]">
              Reliable publishing, scheduling, and analytics for Instagram.
            </p>
          </a>
        </div>
      </div>
