...
export const appRouter = {
  ...
  api: {
    ...
    postsRewrite: "/api/posts/rewrite",
    accountsCallback: "/api/accounts/callback",
    suggestions: "/api/suggestions",
    chat: "/api/chat",
    exploreGenerate: "/api/explore/generate",
    exploreRegenerateImage: "/api/explore/regenerate-image",
    exploreCommit: "/api/explore/commit",
    billingPortal: "/api/billing/portal",
    autopilotSettings: "/api/autopilot/settings",
    autopilotPublishingMode: "/api/autopilot/publishing-mode",
    autopilotGenerateNow: "/api/autopilot/generate-now",
